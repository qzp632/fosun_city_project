<template>
    <div>
        <toptitle toptitle="业务规模" pathkeys="capability"></toptitle>
        ...
        <div class="ywgmbox">
            ...
            <div class="countWapper">
                <span class="ms">板块/万元</span>
                <div>
                    <div class="imsbox">
                        <span class="text">健康</span>
                        <span class="ims ims1"></span>
                        <span class="rs">
                            <span class="ion"></span>
                            <span>健康</span>
                            <span>275万</span>
                    ...
                    <div class="imsbox">
                        <span class="text">快乐</span>
                        <span class="ims ims2"></span>
                        <span class="rs">
                    ...
                    <div class="imsbox">
                        <span class="text">富足</span>
                        <span class="ims ims3"></span>
                        <span class="rs">
...
.countWapper .imsbox .rs{
    float: right;
    font-size: 3vw;
}
.countWapper .imsbox .rs .ion{
...
.countWapper .imsbox .rs .ion2{
    background: red;
}
.countWapper .imsbox .rs .ion3{
    background: yellow;
}
.countWapper .ms {
    font-size: 2.66vw;
